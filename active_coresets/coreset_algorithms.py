...
def bayesian_inference(X: List[np.ndarray], model_from_bitstring: Callable[[str], Model], model_bitstring_len: int, m: int, A: ClassicalAlgorithm, B: QuantumAlgorithm) -> Model:
    coreset = Coreset()
    models = []
